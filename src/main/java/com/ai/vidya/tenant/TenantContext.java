...
public final class TenantContext {
    ...
    public static void setCurrentTenant(UUID schoolId) {
    ...
    public static void setCurrentChain(UUID chainId) {
        CURRENT_CHAIN.set(chainId);
    }

    public static UUID getCurrentChain() {
    ...
    public static boolean isChainAdmin() {
        return "CHAIN_ADMIN".equals(CURRENT_ROLE.get());
    }
}